const DEFAULT_PRODUCTS = [
  {id:'ghost-market',name:'Marketplace Premium',category:'Sites',type:'SITE + PAINEL',badge:'EXCLUSIVO',price:249,icon:'WEB',description:'Loja digital moderna com catálogo, carrinho, páginas de produto e base pronta para checkout.',meta:['HTML/CSS/JS','Responsivo','Editável'],specs:{Entrega:'ZIP',Licença:'Comercial',Código:'Incluído',Suporte:'Instalação'},color:'#d8ff3f',published:true},
  {id:'live-hud',name:'HUD Interativo para Lives',category:'Sistemas',type:'SISTEMA',badge:'PRONTO PARA USAR',price:179,icon:'HUD',description:'Interface para jogos e lives com slots de eventos, placar, comandos e estrutura para integração em tempo real.',meta:['Web','Realtime-ready','Painel'],specs:{Entrega:'ZIP',Licença:'Comercial',Código:'Incluído',Formato:'Web App'},color:'#54d9ff',published:true},
  {id:'knight-pack',name:'Knight Character Pack',category:'GLB / 3D',type:'MODELO 3D',badge:'GLB',price:69,icon:'3D',description:'Pacote de personagem 3D para protótipos e jogos, organizado para importação em engines compatíveis.',meta:['.GLB','Game Asset','3D'],specs:{Entrega:'GLB',Licença:'Comercial',Rig:'Consultar',Texturas:'Incluídas'},color:'#ac80ff',published:true},
  {id:'sprite-pack',name:'Sprite Combat Pack',category:'Assets',type:'SPRITES',badge:'PNG',price:49,icon:'PNG',description:'Conjunto de sprites organizados para jogos 2D, HUDs e protótipos interativos.',meta:['PNG','2D','Game Ready'],specs:{Entrega:'ZIP',Licença:'Comercial',Fundos:'Transparente',Uso:'Jogos 2D'},color:'#ff866e',published:true},
